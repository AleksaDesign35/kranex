...
export default function ServiceLinkCard({ href, title, text, Icon }: Props) {
    return (
        <Link
            href={href}
            className="group flex flex-col rounded-2xl border-2 border-zinc-100 bg-white p-8 transition-all duration-300 hover:border-primary/20 hover:shadow-xl active:border-primary/20 active:shadow-xl"
        >
            ...
            <p className="mb-6 flex-1 leading-relaxed text-zinc-600">{text}</p>
