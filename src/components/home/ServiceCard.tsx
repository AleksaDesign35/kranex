...
export default function ServiceCard({ title, text, Icon }: Props) {
  return (
    <article className="group rounded-2xl border-2 border-zinc-100 bg-white p-5 transition-all duration-300 hover:border-primary/20 hover:shadow-xl active:border-primary/20 active:shadow-xl">
